...
# Hyperparameters
BATCH_SIZE = 32
GAMMA = 0.9454816717225099
EPS_START = 0.8130648594218925
EPS_END = 0.011700768792087226
EPS_DECAY = 1000
TAU = 0.001954113031389691
LR = 1.11147990253847e-05
...
if __name__ == "__main__":
    ...
    policy_net.load_state_dict(torch.load(args.model, weights_only=True))

    seed_time = time.time() if args.seed is None else args.seed
